...
// Simple safe version that works without complex dependencies
const EventsPageSafe = () => {
  const { user } = useAuth();
                    ...
                    {event.maxAttendees && (
                      <div className="mt-3">
                        <div className="flex justify-between text-xs text-gray-500 mb-1">
                          <span>Capacity</span>
                          <span>{Math.round((event.attendees.length / event.maxAttendees) * 100)}%</span>
                        </div>
