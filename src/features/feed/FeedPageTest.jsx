...
const FeedPageTest = () => {
  return (
    <div className="min-h-screen bg-gray-50 p-8">
      <h1 className="text-3xl font-bold text-gray-900 mb-4">Feed Test Page</h1>
      <p className="text-gray-600">This is a test to see if the feed route works.</p>
      ...
      <div className="mt-8 bg-white rounded-lg shadow p-6">
        ...
        <div className="space-y-4">
          <div className="p-4 bg-blue-50 rounded-lg">
            ...
            <p className="text-blue-700">Feed page route is accessible</p>
          </div>
          ...
          <div className="p-4 bg-yellow-50 rounded-lg">
            ...
            <p className="text-yellow-700">Replace with full FeedPage when ready</p>
          </div>
        </div>
      </div>
    </div>
